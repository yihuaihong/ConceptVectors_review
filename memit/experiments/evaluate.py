...
def main(
    ...
    results_save_path = '/U_PZL2023ZZ0005/unlearn_results/llama2-7b/memit/entropy/'
    ...
    for record_chunks in chunks(ds, num_edits):
        ...
        torch.save(results, results_save_path + f"{args.alg_name}_llama_relation_object_test_concept{order}.pt")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/U_PZL2023ZZ0005/jhyu/Llama-2-7b-chat-hf",
        help="Model to edit.",
        required=False,
    )
    parser.add_argument(
